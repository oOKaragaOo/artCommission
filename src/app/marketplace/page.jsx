...
import styles from '../../styles/marketplace.module.css'; // Create this CSS Module file
...
const MarketplacePage = () => {
  ...
  // Sample marketplace item data (replace with your actual data)
  const marketplaceItems = [
    ...
    // Add more items here for both 'selling' and 'sold'
  ...
  const goToHomePage = () => {
    router.push('/'); // Navigate back to the home page (adjust path if needed)
  };
    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.marketplace}>
          <h1 className={styles.pageTitle} onClick={goToHomePage} style={{ cursor: 'pointer' }}>
            Marketplace
          </h1>
              ...
              >
                ...
                {hoveredItem === item.id && (
                  <div className={styles.itemOverlay}>
                    ...
                    {/* You can add a "Buy Now" or "View Details" button here */}
                  </div>
                )}
              </div>
            ))}
